...
client.on('ready', async () => {
    ...
    try {
        ...
        console.error('Error al recargar los comandos:', error);
    }
...
client.on('interactionCreate', async (interaction) => {
    if (!interaction.isCommand()) return;  // Verifica si la interacción es un comando
    ...
    try {
        ...
        await interaction.reply({ content: 'Hubo un error al procesar tu comando. Por favor, intenta nuevamente.', ephemeral: true });
    }
});
